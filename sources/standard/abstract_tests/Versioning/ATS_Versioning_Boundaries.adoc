...
model:: ogc
type:: abstracttest
label:: /ats/versioning/boundaries
subject:: <<req_versioning_boundaries,/req/versioning/boundaries>>
...
description:: For each UML class defined or referenced in the Versioning Package:
