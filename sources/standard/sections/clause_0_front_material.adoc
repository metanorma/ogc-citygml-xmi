...
|Thomas H. Kolbe |Chair of Geoinformatics, Technical University of Munich
|Tatjana Kutzner |Chair of Geoinformatics, Technical University of Munich
|Claus Nagel |Virtual City Systems
|Carsten Roensdorf |Ordnance Survey
|Carl Stephen Smyth |OpenSitePlan
